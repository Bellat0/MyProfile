...
class ProfileCell: UITableViewCell {
    ...
    private func setupConstraints() {
        ...
        let pinLeftAboutMeLabel = NSLayoutConstraint(item: aboutMeLabel, attribute: NSLayoutConstraint.Attribute.leading, relatedBy: NSLayoutConstraint.Relation.equal, toItem: rectView, attribute: NSLayoutConstraint.Attribute.leading, multiplier: 1, constant: 51)
        ...
        let pinRightAboutMeLabel = NSLayoutConstraint(item: aboutMeLabel, attribute: NSLayoutConstraint.Attribute.trailing, relatedBy: NSLayoutConstraint.Relation.equal, toItem: rectView, attribute: NSLayoutConstraint.Attribute.trailing, multiplier: 1, constant: -51)

        let pinLeftLocationIconImage = NSLayoutConstraint(item: locationIconImage, attribute: NSLayoutConstraint.Attribute.leading, relatedBy: NSLayoutConstraint.Relation.equal, toItem: rectView, attribute: NSLayoutConstraint.Attribute.leading, multiplier: 1, constant: 150)
        ...
        let centerYLocationLabel = NSLayoutConstraint(item: locationLabel, attribute: .centerY, relatedBy: .equal, toItem: locationIconImage, attribute: .centerY, multiplier: 1, constant: 0)
